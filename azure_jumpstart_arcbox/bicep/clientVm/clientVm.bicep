...
//Workshop Plus needs these two DCRs
...
resource vm 'Microsoft.Compute/virtualMachines@2022-03-01' = {
  ...
  properties: {
    hardwareProfile: {
      vmSize: flavor == 'DevOps' ? 'Standard_B4ms' : flavor == 'DataOps' ? 'Standard_D4s_v5' : clientVmSku
    }
    storageProfile: {
      osDisk: {
        name: '${vmName}-OSDisk'
